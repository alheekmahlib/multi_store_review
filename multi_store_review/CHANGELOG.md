...
- Update multi_store_review_platform_interface to 2.0.4
...
- Fix iOS no-scene exception. ([#41](https://github.com/devdoxconnect/multi_store_review/issues/41))
# [2.0.2]
...
- Update multi_store_review_platform_interface to 2.0.2
...
- Update multi_store_review_platform_interface to 1.0.5
- Remove dependency on `package_info`.
- Handle `openStoreListing()` with native code for Android, iOS and MacOS.

# [1.0.3]

- Update multi_store_review_platform_interface to 1.0.4
- Update android compileSdkVersion to 29.
- Lower dependency version constraints.

# [1.0.2]

- Update multi_store_review_platform_interface to 1.0.3
...
- Update multi_store_review_platform_interface to 1.0.2

# [1.0.0]

- Migrate to use `multi_store_review_platform_interface`.
