...
/// as `multi_store_review` does not consider newly added methods to be breaking
/// changes. Extending this class (using `extends`) ensures that the subclass
/// will get the default implementation, while platform implementations that
/// `implements` this interface will be broken by newly added
/// [MultiStoreReviewPlatform] methods.
abstract class MultiStoreReviewPlatform extends PlatformInterface {
  ...
  /// class that extends [MultiStoreReviewPlatform] when they register themselves.
